...
randomNumberVariable = 3 + random.randint(1, 20)
#8. Make an if statement that prints if the variable from #7 is greater than, less than, or equal to A + B + C.
if randomNumberVariable > A + B + C :
    print("Random Number is greater than A + B + C")
elif randomNumberVariable < A + B + C :
    print("Random Number is less than A + B + C")
elif randomNumberVariable == A + B + C :
    print("Random Number is equal to A + B + C")